...
Start by creating both formatted parameter tables, and then join them together as seen below:
```{r, eval = eval_bbr_chunks}
boot_df <- boot_ests %>%
...
# Define footnote
footBoot <- glue::glue("CIs were determined from the 2.5th and 97.5th percentiles 
