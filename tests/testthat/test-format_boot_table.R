...
test_that("format_boot_table expected dataframe: col names", {
  #default cols
  expect_equal(names(newDF3),  c("abb", "desc", "boot_value", "boot_ci", "boot_nam", "boot_med"))
...
test_that("format_param_table: .digit produces expected significant digits", {
  ...
  expect_equal(newDF3$boot_value[6], "0.484")
  expect_equal(newDF3$boot_ci[6], "0.408, 0.558")

  newDF4 <- format_boot_table(newbootDF, .digit = 6)
  expect_equal(newDF4$boot_value[6], "0.483687")
  expect_equal(newDF4$boot_ci[6], "0.408194, 0.558204")
})
...
test_that("format_param_table: .maxex produces expected scientific notation", {
  ...
  expect_equal(newDF6$boot_ci[1], "0.000139, 0.0178")
  expect_equal(newDF6$boot_ci[6], "4.08e-05, 0.00558")

  newDF7 <- format_boot_table(newDF5, .maxex = 99)
  expect_equal(newDF7$boot_value[1], "157")
  expect_equal(newDF7$boot_value[10], "8.21")
  expect_equal(newDF7$boot_ci[1], "0.000139, 0.0178")
  expect_equal(newDF7$boot_ci[6], "0.0000408, 0.00558")
  ...
  expect_equal(newDF8$boot_ci[1], "0.00014, 0.018")
  expect_equal(newDF8$boot_ci[6], "0.000041, 0.0056")
