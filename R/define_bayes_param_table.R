#' Combine Bayes parameter estimates with parameter key
#'
#' @description
#'
#' Combines Bayes model output parameter estimates with information in parameter key. Performs
...
#'
#' @export
define_bayes_param_table <- function(.estimates, .key, .ci = 95, .zscore = NULL){
